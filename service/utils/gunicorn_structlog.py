...
# DO NOT REMOVE, this invokes structlog configuration and avoids calling it twice
...
class GunicornLogger(object):
    ...
    def __init__(self, cfg):
        self._error_logger = structlog.get_logger("gunicorn.internal")
    ...
    def access(self, resp, req, environ, request_time) -> None:
        pass  # requests are logged by the application
        # status = resp.status
